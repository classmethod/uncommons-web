...
/**
 * {@link Iterable}の要素のうち、最初に取得できた要素を表すモデル。
 * 
 * <p>{@link Iterable}が要素を持たない場合は、{@code null}となる。</p>
 * 
 * @param <T> 要素の型
 * @since 1.8
 * @version $Id$
...
public class FirstElementModel<T> extends LoadableDetachableModel<T> {
	 ...
	 */
	public FirstElementModel(IModel<? extends Iterable<T>> collectionModel) {
