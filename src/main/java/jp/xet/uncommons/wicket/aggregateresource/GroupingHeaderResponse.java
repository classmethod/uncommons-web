...
import jp.xet.uncommons.wicket.aggregateresource.GroupedAndOrderedResourceReference.ResourceGroup;
 ...
 * @author jthomerson
 */
public class GroupingHeaderResponse extends
		AbstractResourceAggregatingHeaderResponse<HttpAggregatingResourceReferenceCollection, BasicGroupingKey> {
	
	private static final BasicGroupingKey UNKNOWN_CSS_GROUPING_KEY = new BasicGroupingKey(ResourceGroup.UNKNOWN, 0,
			true);
	
	private static final BasicGroupingKey UNKNOWN_JS_GROUPING_KEY = new BasicGroupingKey(ResourceGroup.UNKNOWN, 0,
			false);
