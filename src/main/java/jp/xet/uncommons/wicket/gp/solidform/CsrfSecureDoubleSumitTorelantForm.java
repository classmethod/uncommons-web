...
import jp.xet.uncommons.wicket.gp.CsrfSecureForm;
...
public abstract class CsrfSecureDoubleSumitTorelantForm<T> extends CsrfSecureForm<T> {
	
	private static Logger logger = LoggerFactory.getLogger(CsrfSecureDoubleSumitTorelantForm.class);
	 ...
	 */
	public CsrfSecureDoubleSumitTorelantForm(String id) {
		super(id);
	}
	 ...
	 */
	public CsrfSecureDoubleSumitTorelantForm(String id, IModel<T> model) {
		super(id, model);
	}
