...
/**
 * 指定した {@link IDataProvider} の要素が空<em>ではない</em>場合に visibility がONになるビヘイビア。
 * 
 * @since 1.8
...
public class VisibleIfProviderIsNotEmptyBehavior extends Behavior {
	 ...
	 * @since 1.8
	 */
	public VisibleIfProviderIsNotEmptyBehavior(IDataProvider<?> provider) {
