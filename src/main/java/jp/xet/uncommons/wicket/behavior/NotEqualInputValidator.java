...
/**
 * Validates that the input of two form components is NOT identical. Errors are reported on the second
 * form component with key 'NotEqualInputValidator' and the variables:
 * <ul>
...
public class NotEqualInputValidator extends AbstractFormValidator {
	 ...
	 */
	public NotEqualInputValidator(FormComponent<?> formComponent1, FormComponent<?> formComponent2)
	{
