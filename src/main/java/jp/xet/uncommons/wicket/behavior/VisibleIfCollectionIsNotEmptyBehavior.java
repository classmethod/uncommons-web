...
/**
 * 指定したコレクションモデルの要素が空<em>ではない</em>場合に visibility がONになるビヘイビア。
 * 
 * @since 1.8
...
public class VisibleIfCollectionIsNotEmptyBehavior extends Behavior {
	 ...
	 * @since 1.8
	 */
	public VisibleIfCollectionIsNotEmptyBehavior(IModel<? extends Collection<?>> model) {
